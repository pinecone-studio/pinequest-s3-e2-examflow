...
export function DashboardTopBar({ value, onChange }: DashboardTopBarProps) {
  return (
    <div className="flex h-[84px] w-full flex-col gap-3 backdrop-blur-[4px] lg:flex-row lg:items-center lg:gap-[34px] lg:px-8 lg:py-[22px]">
      <button
        aria-label="Цэс"
      ...
      <label className="group relative flex-1">
        ...
        <input
          className="h-10 w-full rounded-[12px] bg-[rgba(240,242,245,0.5)] px-[42px] pr-[14px] text-[14px] leading-[18px] text-[#18161F] shadow-[0_1px_2px_rgba(0,0,0,0.05)] outline-none placeholder:text-[#52555B]"
